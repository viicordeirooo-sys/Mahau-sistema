...
- **Status:** **Sprints 1 e 2 prontos.** **Sprint 3 (futuro):** fichas técnicas dos drinks autorais, histórico de conciliações, alertas. Export do Resultado: PDF via `window.print()` numa view estilizada (sem lib) e resumo p/ WhatsApp via clipboard.
